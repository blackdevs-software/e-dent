<?php
	...
	$slq_insert_historiaM = "insert into prontuario_historia_medica (queixaPrincipal, historia_doenca_atual, historia_progressa, historia_familiar, historia_pessoal_social, observacao ) values ('$queixaPrincipal', '$historia_doenca_atual', '$historia_progressa', '$historia_familiar', '$historia_pessoal_social', '$observacao')";
